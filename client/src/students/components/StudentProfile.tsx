    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-6">
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    @prethika_s • Information Technology • III Year
                  </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="text-base font-medium text-gray-800">
                    23it1204@stjosephstechnology.ac.in
                  </div>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-gray-200">
                ...
                <div className="text-sm text-gray-600">
                  Senior Developer & Technical Mentor
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Global competitive programming standing across platforms
                </p>
              </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4 hover:border-blue-300 hover:shadow-sm transition-all duration-200">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div
                          className={`p-2 rounded-md ${profile.bgColor} ${profile.borderColor} border`}
                        >
                          <div className={profile.color}>{profile.logo}</div>
                        </div>
                        <div>
                      ...
                      <div
                        className={`text-xs font-medium px-2 py-1 rounded ${profile.bgColor} ${profile.color} border ${profile.borderColor}`}
                      >
                        {profile.rank}
                      </div>
                    </div>
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-gray-800 mt-2">
                  {codingProfiles.reduce(
                    (sum, profile) => sum + profile.solved,
                    0,
                  )}
                </div>
              </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-2xl font-bold text-gray-800 mt-2">
                  {Math.round(
                    codingProfiles.reduce((sum, profile) => {
                      const rating =
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Last active: Just now • Active streak: 15 days
                </p>
              </div>
            </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-500 border-t border-gray-200 pt-6">
          <p>
            Profile last updated: Today • All profile information is verified
          </p>
        </div>
      </div>
    </div>
