...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-bg-card border-b border-border-gray h-16 flex items-center px-8 shadow-sm sticky top-0 z-50 transition-colors duration-300">
      <div className="text-xl font-bold tracking-tight text-text-main mr-12">
        Student Dashboard
      </div>
      ...
      <div className="flex items-center gap-4 ml-auto">
          ...
          {theme === "light" ? (
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M3 12h2.25m.386-4.364l1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z"
              />
            </svg>
          )}
        </button>
        ...
        >
          ...
          <div className="hidden sm:block">
            <div className="text-sm font-semibold text-text-body leading-none group-hover:text-text-main transition-colors">
              {userHandle}
            </div>
