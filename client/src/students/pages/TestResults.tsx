    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="bg-bg-card p-8 rounded-xl shadow-sm border border-border-gray text-center space-y-4">
                ...
                <p className="text-text-body opacity-70">You scored 340 out of 400 points in {slug}.</p>

                <div className="grid grid-cols-3 gap-4 mt-8">
                    <div className="p-4 bg-bg-main rounded-lg">
                        <p className="text-xs text-text-body uppercase font-bold opacity-50">Accuracy</p>
                        <p className="text-xl font-bold text-text-main">85%</p>
                    </div>
                    <div className="p-4 bg-bg-main rounded-lg">
                        <p className="text-xs text-text-body uppercase font-bold opacity-50">Time Spent</p>
                        <p className="text-xl font-bold text-text-main">42m 15s</p>
                    </div>
                    <div className="p-4 bg-bg-main rounded-lg">
                        <p className="text-xs text-text-body uppercase font-bold opacity-50">Rank</p>
