...
const DeleteConfirmationModal: React.FC<DeleteConfirmationModalProps> = ({ isOpen, problemTitle, onClose, onConfirm }) => {
                    ...
                    {step === 1 ? (
                            ...
                            <div className="mt-3 text-center sm:mt-5">
                                ...
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500 dark:text-gray-400">
                                        Do you want to delete this problem? This action cannot be undone.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                <button
                                    type="button"
                                    className={`inline-flex w-full justify-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm sm:ml-3 sm:w-auto ${confirmTitle === problemTitle
                                        ? 'bg-red-600 hover:bg-red-500'
                                        : 'bg-red-300 cursor-not-allowed'
                                        }`}
                                    disabled={confirmTitle !== problemTitle}
                                    onClick={handleFinalConfirm}
                                    title={confirmTitle !== problemTitle ? "Type the exact problem name to enable" : ""}
                                >
                                    Confirm Delete
                                </button>
                                <button
