        ...
        <div className="flex h-screen bg-white overflow-hidden transition-all duration-300">
            ...
            >
                ...
                <nav className="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
                    <div className={`${isSidebarOpen ? 'px-3 mb-2' : 'px-1 mb-1'}`}>
                        <NavLink
                            to="/dashboard"
                            className={({ isActive }) =>
                            ...
                            {({ isActive }) => (
                                <>
                                    <div className={`${isSidebarOpen ? 'mr-3' : ''}`}>
                                        <HomeIcon className={`h-5 w-5 ${isActive ? 'text-white' : 'text-blue-600'}`} />
                                    </div>
                    ...
                    <div className={`${isSidebarOpen ? 'px-3' : 'px-1'}`}>
                        <NavLink
                            to="/problems"
                            className={({ isActive }) =>
                                `flex items-center ${isSidebarOpen ? 'px-3 py-3' : 'px-2 py-3 justify-center'} text-sm font-medium rounded-xl transition-all duration-200 group relative ${isActive
                        ...
                        >
                            {({ isActive }) => (
                                <>
                                    <div className={`${isSidebarOpen ? 'mr-3' : ''}`}>
                                        <PuzzlePieceIcon className={`h-5 w-5 ${isActive ? 'text-white' : 'text-blue-600'}`} />
                                    </div>
                    ...
                    <div className={`${isSidebarOpen ? 'px-3' : 'px-1'}`}>
                        ...
                        >
                            {({ isActive }) => (
                                <>
                                    <div className={`${isSidebarOpen ? 'mr-3' : ''}`}>
                                        <UsersIcon className={`h-5 w-5 ${isActive ? 'text-white' : 'text-blue-600'}`} />
                                    </div>
                    ...
                    <div className={`${isSidebarOpen ? 'px-3' : 'px-1'}`}>
                        ...
                        >
                            {({ isActive }) => (
                                <>
                                    <div className={`${isSidebarOpen ? 'mr-3' : ''}`}>
                                        <TrophyIcon className={`h-5 w-5 ${isActive ? 'text-white' : 'text-blue-600'}`} />
                                    </div>
                ...
                <aside className={`relative w-80 h-full bg-white border-r border-blue-100 shadow-2xl flex flex-col transform transition-transform duration-300 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                    ...
                    <div className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                        ...
                        <div className="mb-4">
                            ...
                            >
                                <PuzzlePieceIcon className="mr-3 h-5 w-5" />
                                Problems
                            </NavLink>
                        </div>
