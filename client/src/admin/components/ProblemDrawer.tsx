  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`fixed inset-y-0 right-0 w-full md:w-3/5 lg:w-1/2 bg-white shadow-2xl transform transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"} flex flex-col`}
        >
          {/* Header */}
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-1 gap-4">
                {problem.samples.map((sample, idx) => (
                  <div
                    key={sample.id}
                    className="relative group bg-gray-50 border border-gray-200 rounded-lg p-5 transition-all hover:shadow-md"
                  >
                    {isEditable && (
                      <button
                        onClick={() => removeSample(idx)}
                        className="absolute top-3 right-3 text-gray-400 hover:text-red-500 p-1 hover:bg-red-50 rounded-md transition-colors"
                        type="button"
                      >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          {isEditable ? (
                            ...
                            <div className="mt-1 bg-white border border-gray-200 p-2.5 rounded-md text-sm font-mono text-gray-800">
                              {sample.input}
                            </div>
                          )}
                        </div>
                      ...
                      {sample.explanation && (
                        <div className="pt-2 border-t border-gray-200">
                          ...
                          {isEditable ? (
                            ...
                            <p className="mt-1 text-sm text-gray-600 bg-blue-50/50 p-2 rounded border border-blue-100">
                              {sample.explanation}
                            </p>
                          )}
                        </div>
