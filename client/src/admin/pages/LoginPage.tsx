            ...
            <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8 transition-all duration-300">
                ...
                <div className="flex justify-center mb-6">
                    <div className="h-14 w-14 rounded-full text-white flex items-center justify-center font-bold">
                        <img src="https://th.bing.com/th/id/R.99834f107c683a783f964224c28532cc?rik=zg61i%2fYTLggECw&riu=http%3a%2f%2ficrtet2019.stjosephstechnology.ac.in%2fimg%2fsjit.png&ehk=DdHRFSvOHLSZcfzmk1mwK53v%2fL0wgvdshIHKllSAKjA%3d&risl=&pid=ImgRaw&r=0" alt="" />
                    </div>
                </div>
