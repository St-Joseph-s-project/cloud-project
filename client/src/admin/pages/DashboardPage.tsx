              ...
              <div className="flex items-start justify-between">
                <div>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span
                      className={`text-xs font-medium px-2 py-1 rounded ${item.bgColor} ${item.color} border ${item.borderColor}`}
                    >
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div className="flex-shrink-0 mt-0.5">
                        <div
                          className={`p-2 rounded-md ${activity.type === "create" ? "bg-blue-50" : activity.type === "user" ? "bg-green-50" : "bg-purple-50"}`}
                        >
