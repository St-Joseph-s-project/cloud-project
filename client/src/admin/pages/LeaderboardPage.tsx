      ...
      <div className="container mx-auto px-4 py-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">
            Top performing students ranked by achievements
          </p>
        </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-lg font-bold text-gray-800 mt-1">
                  {Math.round(
                    data.reduce((sum, entry) => sum + entry.score, 0) /
                      data.length,
                  )}
                </div>
              </div>
                ...
                >
                  <div className="grid grid-cols-12 gap-4 px-6 py-4 items-center">
                    ...
                    <div className="col-span-1">
                      <div
                        className={`inline-flex items-center justify-center w-10 h-10 rounded-md border ${getRankColor(entry.rank)} font-semibold`}
                      >
                    ...
                    <div className="col-span-2">
                      <div className="flex items-center">
                        <FireIcon
                          className={`h-4 w-4 ${entry.streak > 20 ? "text-red-500" : "text-orange-500"} mr-2`}
                        />
                    ...
                    <div className="col-span-1">
                      <span
                        className={`inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium border ${getCategoryColor(entry.category)}`}
                      >
        ...
        <div className="mt-6 flex items-center justify-between">
          <div className="text-sm text-gray-600">
            ...
            <span className="font-medium">
              1-{Math.min(filteredData.length, 10)}
            </span>{" "}
