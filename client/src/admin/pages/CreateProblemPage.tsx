...
const inputClasses =
  "block w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 sm:text-sm transition-all duration-200 placeholder:text-gray-400";
...
const CreateProblemPage: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      await dispatch(
        createProblem({ ...problem, created_by: (user as any)?.id }),
      ).unwrap();
  ...
  const handleRunCode = async () => {
    // Here you would typically send the code to a compilation service
    // For now we'll just simulate running it
  ...
  return (
    <div className="relative">
      {/* Main Content Area */}
      <div
        className={`transition-all duration-300 ease-in-out ${isEditorOpen ? "mr-0 xl:mr-[500px]" : ""}`}
      >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">
                Define problem details, test cases, and solution
              </p>
            </div>
          </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setProblem({
                        ...problem,
                        output_weight: parseInt(e.target.value),
                      } as any)
                    }
                    className={inputClasses}
                    placeholder="100"
            ...
            <div className="bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                ...
                {problem.samples.map((sample, idx) => (
                  <div
                    key={sample.id}
                    className="border border-gray-200 rounded-xl p-5 bg-gray-50/30 hover:border-blue-200 transition-all group relative"
                  >
            ...
            <div className="bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                ...
                {problem.testCases.map((tc, idx) => (
                  <div
                    key={tc.id}
                    className="border border-gray-200 rounded-xl p-5 bg-gray-50/30 hover:border-purple-200 transition-all group relative"
                  >
                    <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className={`${inputClasses} font-mono text-xs`}
                          placeholder="Expected secret output..."
                        />
                      </div>
                    </div>
                  </div>
      ...
      <div
        className={`flex flex-col bg-white border-l border-gray-200 shadow-2xl z-40 transition-all duration-300 ease-in-out fixed top-16 right-0 bottom-0 ${
          isEditorOpen
