...
export const ProblemProvider = ({ children }: { children: ReactNode }) => {
    ...
    return (
        <ProblemContext.Provider value={{ problems, addProblem, updateProblem, getProblem }}>
            {children}
...
export const useProblems = () => {
    ...
    if (!context) throw new Error('useProblems must be used within a ProblemProvider');
    return context;
};
